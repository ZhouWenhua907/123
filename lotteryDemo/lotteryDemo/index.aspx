<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="lotteryDemo.index" %>
...
<form runat="server">
    <div class="turnplate_box">
        ...
        <asp:Button ID="tupBtn" class="turnplatw_btn" runat="server"/>
    </div>
    <div class="buttom">
        您还剩余<asp:Label ID="lotteryNum" runat="server" Text="0"></asp:Label>次抽奖机会<br/>
        <asp:Button ID="checkCoupon" runat="server" Text="查看优惠券" />
    </div>
    <!-- 更改系统默认弹窗 -->
    <script type="text/javascript">
        window.alert = function (str) {
            ...
            strHtml += " <li style=\"background:#626262;text-align:left;padding-left:20px;font-size:14px;font-weight:bold;height:25px;line-height:25px;border:1px solid #F9CADE;color:white\">[中奖提醒]优惠券信息</li>\n";
    ...
    <script>
        ...
        function ShowLOtteryNum(r){
                if (r.ok) {
                    
                    for (var i = 0; i < r.lst.length; i++)
                    {
                        var num = r.lst[i];
                        $("#lotteryNum").text(num.LotteryNum);
                    }
